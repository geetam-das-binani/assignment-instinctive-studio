...
import { setSearchTerm } from "../reducers/postReducer";
const Navbar = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      toast.error(error.message || "Something went wrong", { icon: "❌" });
    }
  };
  return (
    <nav className="w-full h-16 bg-gray-50 ">
      <div className="flex items-center justify-between p-4 mx-auto ">
        ...
        >
          <div
            className={`h-1 w-6 bg-gray-400 rounded-sm
        ...
        <div className="items-center hidden md:flex">
          <ul className="flex items-center flex-1 mr-56 space-x-14">
            <li>
              <a
                href="
                #"
